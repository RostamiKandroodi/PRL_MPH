function loglik = Simmodel_EWA_F3(params,dat)
% WRAPPER FUNCTION: EWA + Forgetting model 
% Same parameter for both PLA & MPH sessions EXCEPT 3th parameter
% INPUT
% params : free parameters of model 
%           params(1) is rho
%           params(2) is phi
%           params(3) is forgetting factor  (PLA)
%           Params(4) is forgetting factor for MPH (this is PLA-Delta)
...
QM = EWA_F_model([alpha(1),alpha(2),alpha(4)],actionsM,outcomeM);
% loglik is the output: sum of the log-probability of all actions
